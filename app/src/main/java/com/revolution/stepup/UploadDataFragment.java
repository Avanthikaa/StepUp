...
public class UploadDataFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = (ProgressBar) rootView.findViewById(R.id.uploadDataProgressBar);
        ...
        protected void onPostExecute(String s) {
            ...
            StringRequest sr = new StringRequest(Request.Method.POST,GoogleSignInActivity.SERVER_URL+"/createPost", new Response.Listener<String>() {
                ...
                protected Map<String,String> getParams(){
                    ...
                    if(imageDescription.getEditableText().toString().equals("")){
                        params.put("content", "");
                        params.put("type","2");
                    }else{
                        params.put("content",imageDescription.getEditableText().toString());
                        params.put("type","3");
                    }
                    return params;
                }
