...
public class GoogleSignInActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,View.OnClickListener{
    ...
    public static String SERVER_URL = "http://139.59.60.161";
                ...
                if (user != null) {
                    ...
                    StringRequest sr = new StringRequest(Request.Method.POST,SERVER_URL+"/login", new Response.Listener<String>() {
                        ...
                        protected Map<String,String> getParams(){
                            ...
                            params.put("profile_image_url", FirebaseAuth.getInstance().getCurrentUser().getPhotoUrl().toString());
                            return params;
                        }
                    };
                    queue.add(sr);
